...
export class Backend implements backendInterface {
    ...
    async getSubmissionById(arg0: string): Promise<ContactSubmission> {
        if (this.processError) {
            try {
    ...
    async submitContactForm(arg0: string, arg1: string, arg2: string | null, arg3: string, arg4: string): Promise<string> {
        if (this.processError) {
            try {
